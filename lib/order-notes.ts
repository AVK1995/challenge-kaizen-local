 ...
 *
 * The old layout was at 14 of 15 keys with a single slot spare, which was
 * already a design that could not accept another field. The fulfilment
 * hand-off now needs twenty-five, including a user agent and a landing url
 * that are individually longer than one note.
 *
